...
class Sponsercor extends REST_Controller {
    ...
    public function index_post() {
        ...
        else
        {
            $user=array('name' => $this->input->get_post('name'),'email' => $this->input->get_post('email'), 
				 ...
				 'quantity' => $this->input->get_post('quantity'), 'stype' => 'Coorporate', 'category' => $this->input->get_post('category'),
				 'company_name' => $this->input->get_post('company_name'), 'price'  => $this->input->get_post('price'), 
