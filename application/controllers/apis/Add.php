...
class Add extends CI_Controller {
    ...
    public function view($id)
    {
        ...
        $data['advocacy']=$this->advocacy_model->get($id);
        $data['site_title'] = 'Admin Dashboard'; //Title
        $data['page_title'] = 'Advocacy';
        $this->load->view('header',$data);
    ...
    function index()
    {
        if ($this->input->server('REQUEST_METHOD') == 'POST'){
            ...
            $this->form_validation->set_rules('age_above_r_nt', 'Age', 'trim|required');
            $this->form_validation->set_rules('language_u_speak[]', 'Languages', "trim|required");
            ...
            $this->form_validation->set_rules('attend_training', 'Attend Traning', 'trim|required');
            $this->form_validation->set_rules('r_u_volunteer', 'Voluteer', 'trim|required');
            $this->form_validation->set_rules('traning_fee', 'Traning Fee', 'trim|required');
            $this->form_validation->set_rules('unpain_volunteer', 'Un paid Volunteer', 'trim|required');
            $this->form_validation->set_rules('understand_r_not', '', 'trim|required');
    ...
    function paidvolunteer($id){
        if ($this->input->server('REQUEST_METHOD') == 'POST'){
            ...
            else
            {
                ...
                $merchantResponseUrl = site_url()."advocacy/return/".$id;
