...
class Sponserind extends REST_Controller {
    ...
    public function index_post() {
        ...
        else
        {
            $user=array('name' => $this->input->get_post('name'),'email' => $this->input->get_post('email'), 
				 ...
				 'quantity' => $this->input->get_post('quantity'), 'stype' => 'Individual', 'category' => $this->input->get_post('category'),
				 'category' => $this->input->get_post('category'), 'price'  => $this->input->get_post('price'), 
				 'payment_type' => $this->input->get_post('payment_type'), 'status' => 'Active'
				 );
            $register_user = $this->sponser_model->individual_sponser($user);
