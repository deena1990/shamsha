...
<div class="main-content">
    ...
    <ol class="breadcrumb breadcrumb-2">
        ...
        <li class="active"><strong>Add Resource Category</strong></li>
    </ol>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title">Add Resource Category</h3>
                ...
                <div class="panel-body">
                    ...
                    <form name="add"   method="POST" action="<?php echo base_url();?>resource_category/add" enctype="multipart/form-data">
                        <div class="row">
