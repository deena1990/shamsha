...
<div class="main-content">
    <h1 class="page-title">Add Survivor support tool</h1>
    <!-- Breadcrumb -->
    <ol class="breadcrumb breadcrumb-2">
        <li><a href="<?php echo base_url(); ?>Dashboard"><i class="fa fa-home"></i>Home</a></li>
        <li><a href="<?php echo base_url(); ?>survivor_tools/">Survivor support tools</a></li>
        <li class="active"><strong>Add Survivor support tool</strong></li>
    </ol>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title">Add Survivor support tool</h3>
                ...
                <div class="panel-body">
                    ...
                    <form name="add" method="POST" action="<?php echo  base_url();?>survivor_tools/add" enctype="multipart/form-data">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="emailaddress"> Name <span style="color:red">*</span></label>
                                <input type="text" value="<?php echo set_value('name') ?>" class="form-control" name="name" placeholder="Name"> <span style="color: red"><?php echo form_error('name');  ?></span> </div>
                            <div class="form-group col-md-6">
