	...
	<div class="main-content">
		<h1 class="page-title">Volunteer Logs</h1>
		<!-- Breadcrumb -->
		<ol class="breadcrumb breadcrumb-2"> 
			<li><a href="<?php echo base_url(); ?>Dashboard"><i class="fa fa-home"></i>Home</a></li> 
			<li class="active"><strong>Volunteer Logs</strong></li>  
		</ol>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h3 class="panel-title">Volunteer Logs List</h3>
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover dataTables-example">
								...
								<tbody class="text-center"> 
									<?php $j=0; for($i=0; $i<count($volunteer_logs);$i++) { ?>
									<tr>
										<td><?php echo ++$j;?></td>
										<td><?php echo $volunteer_logs[$i]->volunteer_id ?></td>
										<td><?= $volunteer_logs[$i]->onduty_status == 0 ? "Inactive" : "Active" ?></td>
										<td><?php echo $volunteer_logs[$i]->dateTime ?></td>
										<!-- <td>
