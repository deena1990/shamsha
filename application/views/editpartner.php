			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						 ...
						 <form name="add"   method="POST" action="<?php echo base_url();?>partner/edit/<?php echo $partner[0]->id;?>" enctype="multipart/form-data">
						
							
							<div class="row">
								<div class="form-group col-xs-6">
									<label for="emailaddress">Name</label>
									<input type="text" class="form-control" name="name" id="emailaddress"  value="<?php echo $partner[0]->pname;?>">
								</div>
							</div>
							<div class="row">
								<div class="form-group col-xs-6">
									<label for="emailaddress">Designation</label>
									<input type="text" class="form-control" name="designation" id="emailaddress" value="<?php echo $partner[0]->website;?>">
								</div>
							</div>
							<div class="row">
								<div class="form-group col-xs-6">
									...
									<input type="hidden" class="form-control" name="image1" value="<?php echo $partner[0]->image;?>">
									<img src="<?php echo $partner[0]->image;?>" style="width:120px;">
								</div>
							</div>
