        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form name="add"   method="POST" action="<?php echo  base_url();?>usermanagement/edit/<?php echo $userdetail->id ?>" enctype="multipart/form-data">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="status">
                                    <option value="Active" <?php echo set_select('status', "Active", ("Active" ==  set_value('status', $userdetail->status))); ?>>Active</option>
                                    <option value="Inactive" <?php echo set_select('status', "Inactive", ("Inactive" ==  set_value('status', $userdetail->status))); ?>>Inactive</option>
                                </select>
