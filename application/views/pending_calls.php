	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><strong>Pending Calls</strong></li>  
		</ol>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h3 class="panel-title">Pending Call List</h3>
							...
							<table class="table table-striped table-bordered table-hover dataTables-example">
								...
								<tbody> 
									...
									<tr>
										...
										<td><?= $calls[$i]->videoCall_status == 1 ? "Video Call" : "Voice Call" ?></td>
										<td>
											<a href="<?php echo base_url(); ?>pending/view_pending_call/<?php echo $calls[$i]->case_id;?>"><i class="fa fa-eye"></i></a> 
