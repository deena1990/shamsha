...
<div class="main-content">
    ...
    <ol class="breadcrumb breadcrumb-2">
        ...
        <li class="active"><strong>Edit Permission</strong></li>
    </ol>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form name="add"   method="POST" action="<?php echo  base_url();?>permissions/edit/<?php echo $roledetail->id ?>" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="module_id">
                                    ...
                                    foreach ($modules as $module){
                                        echo "<option value='".$module->id."' ".set_select('module_id', $module->id, ($module->id ==  set_value('module_id', $roledetail->module_id))).">".$module->name."</option>";
                                    }
                                    ?>
                                </select>
