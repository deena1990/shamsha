    ...
    <script>
        $(document).ready(function(){
            var dataTables =  $('#sponserDatatable').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo base_url('permissions/getpermissions/'); ?>",
                    "type": "POST"
                },
                //Set column definition initialisation properties
                "columnDefs":[{"targets":6, "data":"id", "render": function(data,type,full,meta)
                    { return '<p class="text-center"><a href="<?php echo base_url(); ?>permissions/edit/'+full[6]+'"><i class="fa fa-pencil" style="color:green;"></i></a></p>'
                    }}]
