...
<div class="main-content">
    ...
    <ol class="breadcrumb breadcrumb-2">
        ...
        <li class="active"><strong>Add Manager on Duty</strong></li>
    </ol>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title">Add Manager on Duty</h3>
                ...
                <div class="panel-body">
                    ...
                    <form name="add"   method="POST" action="<?php echo base_url();?>manager_on_duty/add">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="startDate" class="form-control" name="start_date" value="<?php echo set_value('start_date') ?>">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="endDate" class="form-control" name="end_date" value="<?php echo set_value('end_date') ?>">
