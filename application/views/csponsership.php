	...
	<div class="main-content">
		<h1 class="page-title">Corporate Sponsership</h1>
		<!-- Breadcrumb -->
		<ol class="breadcrumb breadcrumb-2"> 
			<li><a href="<?php echo base_url(); ?>Dashboard"><i class="fa fa-home"></i>Home</a></li> 
			<li class="active"><strong>Corporate Sponsership</strong></li> 
		</ol>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h3 class="panel-title">Corporate Sponsership</h3>
					...
					<div class="panel-body">
						 ...
						 <form name="add"   method="POST" action="<?php echo base_url();?>sponsership/csponser/6" enctype="multipart/form-data">
							<div class="row">
